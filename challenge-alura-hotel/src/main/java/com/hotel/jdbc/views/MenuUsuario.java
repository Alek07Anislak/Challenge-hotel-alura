...
public class MenuUsuario extends JFrame {  //SISTEMA DE RESERVAS HOTEL ALURA (luego del login)
	...
	public MenuUsuario() {
		...
		final JPanel btnRegistro = new JPanel();//Se añadio 'final' para que 'btnRegistro' no sea modificada despues de su inicialización
		...
		final JPanel btnBusqueda = new JPanel();//Se añadio final 
		...
		final JPanel btnexit = new JPanel(); // se añadio final
	    ...
	    String textoDescripcion = "<html><body>Sistema de reserva del <b>HOTEL ALURA</b> donde Ud. podra Controlar y administrar de forma óptima y fácil el flujo de reservas y de huespédes   </body></html>";
