...
public class Login extends JFrame {
	...
	/**
	 * Launch the application./INICIANDO LA APLICACIÓN
	 */
	...
	public Login() {
		...
		final JPanel btnexit = new JPanel();//Se aumeto final
	...
	private void headerMousePressed(java.awt.event.MouseEvent evt) { //Código que permite al usuario arrastrar la ventana de la aplicación LOGIN con el mouse, haciendo que la ventana se mueva según el movimiento del mouse en la pantalla.
	        xMouse = evt.getX();
	        yMouse = evt.getY();
